 ...
 *
 * @author Ben Alex
 * @version $Id: DataSourcePopulator.java 1754 2006-11-17 02:01:21Z benalex $
 */
...
//        List<IProject> projects = projectDAO.findAll();
//        for (int i = 0; i < projects.size(); ++i) {
//            final ObjectIdentity objectIdentity = new ObjectIdentityImpl(Project.class, new Long(i+1));
...
//        }
      ...
      for (IProject p : projects) {
        MutableAcl acl;
        ObjectIdentity oid = new ObjectIdentityImpl(Project.class, p.getId());
        ...
        acl.insertAce(null, BasePermission.ADMINISTRATION, new PrincipalSid("marissa"), true);
        
        updateAclInTransaction(acl);
//        mutableAclService.updateAcl(acl);
      }

//      final ObjectIdentity objectIdentity = new ObjectIdentityImpl(Project.class, new Long(1));
//      tt.execute(new TransactionCallback() {
//              public Object doInTransaction(TransactionStatus arg0) {
//                  MutableAcl acl = mutableAclService.createAcl(objectIdentity);
//
...
//
    private void grantPermissions(int contactNumber, String recipientUsername, Permission permission) {
        AclImpl acl = (AclImpl) mutableAclService.readAclById(new ObjectIdentityImpl(Project.class,
                    new Long(contactNumber)));
