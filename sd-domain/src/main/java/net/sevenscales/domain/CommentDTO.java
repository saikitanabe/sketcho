...
public class CommentDTO extends DiagramItemDTO {
	...
	public CommentDTO(String text, String type, String shape, String backgroundColor, String textColor, Integer tsize,
		...
		super(text, type, shape, backgroundColor, textColor, tsize, /* shapeProperties */null, /* displayOrder */ null, version, id, clientId, customData, crc32, annotation, resolved, links);
