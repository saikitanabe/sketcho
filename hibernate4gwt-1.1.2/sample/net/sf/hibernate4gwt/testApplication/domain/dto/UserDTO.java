...
public class UserDTO extends LazyPojo implements IUser
{
	...
	/**
	 * @gwt.typeArgs <net.sf.hibernate4gwt.testApplication.domain.dto.MessageDTO>
	 */
	...
	/**
	 * @gwt.typeArgs messageList <net.sf.hibernate4gwt.testApplication.domain.dto.MessageDTO>
