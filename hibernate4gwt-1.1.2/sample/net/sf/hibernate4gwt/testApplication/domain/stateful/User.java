 ...
 */
public class User implements Serializable, IsSerializable, IUser
{
	/**
	 * Serialisation ID
	 */
	...
	/**
	 * @gwt.typeArgs <net.sf.hibernate4gwt.testApplication.domain.stateful.Message>
	 */
	...
	/**
	 * @gwt.typeArgs messageList <net.sf.hibernate4gwt.testApplication.domain.stateful.Message>
