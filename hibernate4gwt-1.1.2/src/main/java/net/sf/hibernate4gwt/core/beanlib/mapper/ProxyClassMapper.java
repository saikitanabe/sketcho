...
public class ProxyClassMapper implements IClassMapper 
{
	...
	//-------------------------------------------------------------------------
	/* (non-Javadoc)
	 * @see net.sf.hibernate4gwt.core.beanlib.IClassMapper#getSourceClass(java.lang.Class)
	 */
	...
	/* (non-Javadoc)
	 * @see net.sf.hibernate4gwt.core.beanlib.IClassMapper#getTargetClass(java.lang.Class)
	 */
