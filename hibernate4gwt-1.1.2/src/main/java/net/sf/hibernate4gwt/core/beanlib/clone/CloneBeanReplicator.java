...
public class CloneBeanReplicator extends HibernateBeanReplicator
{
	...
	{
		super(newBeanTransformer(classMapper, persistenceUtil, pojoStore));
	}
	...
	//
		transformer.initDetailedBeanPopulatable(new CloneBeanPopulatable(persistenceUtil, pojoStore));
    	
	//	Protected and private setter collection
	//
    	transformer.initSetterMethodCollector(SortedSetterMethodCollector.inst);
