...
//			logger.log(TreeLogger.ERROR, "Proxy generation error", ex);
	...
	//
		...
		if ((net.sf.hibernate4gwt.pojo.java14.LazyPojo.class.getCanonicalName().equals(superclassName)) ||
			(net.sf.hibernate4gwt.pojo.java5.LazyPojo.class.getCanonicalName().equals(superclassName)))
		{
			return true;
		}
