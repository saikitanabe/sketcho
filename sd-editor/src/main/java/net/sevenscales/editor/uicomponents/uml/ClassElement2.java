...
public class ClassElement2 extends AbstractDiagramItem implements SupportsRectangleShape {
  ...
  public ClassElement2(SurfaceHandler surface, RectShape newShape, String text, Color backgroundColor, Color borderColor, Color textColor, boolean editable) {
    this(surface, newShape, text, backgroundColor, borderColor, textColor, editable, false);
  }
  
  public ClassElement2(SurfaceHandler surface, RectShape newShape, String text, Color backgroundColor, Color borderColor, Color textColor, boolean editable, boolean delayText) {
  ...
  protected Diagram createDiagram(SurfaceHandler surface, RectShape newShape,
