package net.sevenscales.confluence.plugins.servlet;
 ...
 *
 * This servlet can be reached at http://localhost:2990/jira/plugins/servlet/net.sevenscales.confluence.plugins.sketcho-confluence/license
 */
public class LicenseServlet extends HttpServlet
{
    ...
    private Map<String, Object> initVelocityContext(HttpServletResponse resp)
    {
        ...
        URI servletUri = URI.create(applicationProperties.getBaseUrl() + "/plugins/servlet/net.sevenscales.confluence.plugins.sketcho-confluence/license");
