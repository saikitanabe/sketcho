...
import net.sevenscales.sketcho.client.app.view.MenuNavigationView;

public class MenuNavigationController extends ControllerBase<Context> {
	private MenuNavigationView view;
	
	private MenuNavigationController(Context context) {
	   super(context);
	}
	...
	public static ClassInfo info() {
		return new ClassInfo() {
			public Object createInstance(Object data) {
				return new MenuNavigationController((Context) data);
			}

			public Object getId() {
				return MenuNavigationController.class;
			}
		};
	}
	...
	public void activate(Map requests, ActivationObserver observer) {
		if (view == null) {
			view = new MenuNavigationView(this);
		}
	}
