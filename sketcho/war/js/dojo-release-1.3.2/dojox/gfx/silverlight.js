...
if(dojo.isSafari){
obj="<embed type='application/x-silverlight' id='"+_66+
	"' width='"+_61+
	"' height='"+_62+
...
obj="<object type='application/x-silverlight' data='data:application/x-silverlight,' id='"+_66+
	"' width='"+_61+
	"' height='"+_62+"'>"+
